class Contact {
    ...
    Contact(String contactPerson, String email, String mobile) {
...
class CompanyContact extends Contact {
    ...
    CompanyContact(String contactPerson, String email, String mobile, String CompanyName, String department,
